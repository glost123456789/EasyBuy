...
<script type="text/javascript">
	if(${not empty SameLoginErr}){
		if(confirm("${SameLoginErr}")){
			$.ajax({
				"url":"easybuyuserservlet?option=11",
			    "data":{"random":Math.random(),"myuser":"${myuser.eu_user_id}"},
			    "success":function(){},
			});
		}
		else{
			$.ajax({
				"url":"easybuyuserservlet?option=12",
...
<div id="header" class="wrap">
	...
	<div class="help">
	<c:choose>
		<c:when test="${empty sessionScope.myuser }">
...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎回到易买网</h1>
			<form id="loginForm" method="post" action="easybuyuserservlet?option=4" >
				<table>
					<tr>
					...
					<td class="field">验证码：</td>
						<td>
                            <img src="verifycodeservlet" id="safeCode"/><a id="changeCode" href="#" >看不清，换一张</a><br>
	                        <input type="text" name="code"><div class="mess">${checkcodeMsg }</div>
							<span></span>
						</td>
					</tr>
					<tr>
