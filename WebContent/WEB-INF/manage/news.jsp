...
<body>
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="newsservlet?option=2">新闻</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
...
<div id="main" class="wrap">
		...
		<div class="manage">
			<table class="list">
				...
				<tr>
					...
					<td>${news.en_title }</td>
					<td class="w1 c"><a href="newsservlet?option=3&id=${news.en_id }">修改</a> <a class="manageDel" href="newsservlet?option=5&id=${news.en_id }">删除</a></td>
				</tr>
				</c:forEach>
			</table>
		</div>
    ...
    <div class="pager">
				<ul class="clearfix">
					<li><a href="newsservlet?option=2&currentpage=1">首页</a></li>
					<li>...</li>
					<c:choose>
						...
						<c:forEach begin="1" end="${totalpage }" var="pageNumber">
							<c:choose>
								...
								<c:otherwise>
									<li><a href="newsservlet?option=2&currentpage=${pageNumber }">${pageNumber }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						</c:when>
                    ...
                    <li>...</li>
					<li><a href="newsservlet?option=2&currentpage=${totalpage }">尾页</a></li>
				</ul>
			</div>
</div>
<div id="footer">
