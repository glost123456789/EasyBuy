...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加商品</h2>
		<div class="manage">
			<form id="productAdd" action="productviewservlet" method="post" enctype="multipart/form-data">
				...
				<table class="form">
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice" value="" /> 元<span></span></td>
					</tr>
					
					<tr>
						<td class="field">商品原价(选填)：</td>
						<td><input type="text" class="text tiny" name="productOriginPrice" value="" /> 元<span></span></td>
					</tr>
					
					<tr>
						<td class="field">库存(*)：</td>
						<td><input type="text" class="text tiny" name="productNumber" value=""/><span></span></td>
					</tr>
					<tr>
