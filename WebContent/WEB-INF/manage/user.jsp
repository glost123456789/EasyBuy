...
<div id="main" class="wrap">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach var="user" items="${userlist }">
					...
					<td class="w1 c"><a href="easybuyuserservlet?option=9&userid=${user.eu_user_id }">修改</a> <a class="manageDel" href="easybuyuserservlet?option=8&userid=${user.eu_user_id }">删除</a></td>
				</tr>
				</c:forEach>
			</table>
		</div>
	...
	<div class="clear"></div>
     <div class="pager">
				<ul class="clearfix">
					<li><a href="easybuyuserservlet?option=7&currentpage=1">首页</a></li>
					<li>...</li>
					<c:choose>
						...
						<c:forEach begin="1" end="${totalpage }" var="pageNumber">
							<c:choose>
								...
								<c:otherwise>
									<li><a href="easybuyuserservlet?option=7&currentpage=${pageNumber }">${pageNumber }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						</c:when>
                    ...
                    <li>...</li>
					<li><a href="easybuyuserservlet?option=7&currentpage=${totalpage }">尾页</a></li>
				</ul>
			</div>
</div>
<div id="footer">
