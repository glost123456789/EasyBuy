...
<script type="text/javascript">
	goBuy("${nowproduct.ep_id }", "${nowproduct.ep_price}");
	$(function(){
		$("#shopbussubmit").click(function(){
			if(${empty myuser})
			{
				alert("请先登录!");
				return false;
			}
			location.href="shoppingservlet?option=1";
			return false;
		});
		$("#shopsubmit").click(function(){
			...
			location.href ="shoppingservlet?option=5&id=${nowproduct.ep_id}";
			return false;
		});
	});
...
<div id="position" class="wrap">
	您现在的位置：<a href="indexservlet">易买网</a> &gt; 商品
</div>
<div id="main" class="wrap">
	...
	<div id="product" class="main">
		<h1>${nowproduct.ep_name }</h1>
		<div class="infos">
			<div class="thumb"><img src="files/${nowproduct.ep_file_name }" width="110" height="106" /></div>
			<div class="buy">
				商城价：<span class="price">￥${nowproduct.ep_price }&nbsp&nbsp${nowproduct.ep_brand }</span><br />
				<c:if test="${nowproduct.ep_origin_price!=0.0 }"><s class="origin">原价：${nowproduct.ep_origin_price }</s></c:if>
				库　存：${nowproduct.ep_stock }
			  <div class="button"><input type="button" name="button" value="" id="shopsubmit" /><a id="shopbussubmit" href="#">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
...
<div id="footer">
	Copyright &copy; 2013 ZR All Rights Reserved. 沪ICP证1000001号
</div>
</body>
</html>