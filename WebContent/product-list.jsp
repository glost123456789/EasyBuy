...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
		<c:if test="${thiscategoryid==17 }">
			<li><a href="indexservlet">首页</a></li>
			<li class="current"><a href="productviewservlet?option=7&categoryid=17">图书</a></li>
			<li><a href="productviewservlet?option=7&categoryid=1">百货</a></li>
		</c:if>
		<c:if test="${thiscategoryid==1 || thisparentcategoryid==1}">
			<li><a href="indexservlet">首页</a></li>
			<li><a href="productviewservlet?option=7&categoryid=17">图书</a></li>
			<li class="current"><a href="productviewservlet?option=7&categoryid=1">百货</a></li>
		</c:if>
		<c:if test="${thiscategoryid!=1 && thiscategoryid!=17 && thisparentcategoryid!=1}">
...
<div id="position" class="wrap">
	您现在的位置：<a href="indexservlet">易买网</a> &gt;<c:if test="${thiscategory.epc_parent_id!=0 }"><a href="productviewservlet?option=7&categoryid=${thisparentcategory.epc_id }">${thisparentcategory.epc_name }</a> &gt;</c:if>  ${thiscategory.epc_name }
</div>
